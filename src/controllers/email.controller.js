...
exports.postEmail = async (req, res) => {
    try {
        ...
        const handleModel = ()=>{
            ...
            if(Model === 'Head'){
                return "https://wevibebucket.s3.ap-northeast-2.amazonaws.com/Model30_Head.png"
            }
            if(Model === 'Head w/ 15” x1 speaker cabinet'){
                return "https://wevibebucket.s3.ap-northeast-2.amazonaws.com/Model30_Head15_x1.png"
            }
            if(Model === 'Head w/ 10”x4 speaker cabinet'){
                return "https://wevibebucket.s3.ap-northeast-2.amazonaws.com/Model30_Head10_x4.png"
            }
            if(Model === 'Model C4'){
